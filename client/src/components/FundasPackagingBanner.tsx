...
export default function FundasPackagingBanner() {
  return (
    <div
      className="mb-6 sm:mb-8 flex flex-col sm:flex-row gap-4 items-center rounded-[0.77em] border-2 border-amber-200/80 dark:border-amber-800/60 bg-amber-50/90 dark:bg-amber-950/30 p-4 sm:p-5 shadow-sm"
      role="complementary"
    ...
    >
      <img
        ...
        decoding="async"
      />
      <p className="text-sm sm:text-base text-black dark:text-white text-center sm:text-left leading-relaxed">
        Con{" "}
